...
export const metadata: Metadata = createMetadata({
  title:
    "Tetraonix HRMS | Workforce Management, ATS, Compliance & Attendance Platform",
  description:
  ...
  keywords: [
    ...
    "ATS and onboarding software",
    "US HR compliance software",
...
const modules = [
  [
    "Candidate pipeline",
    "Capture applicants, manage submissions, schedule interviews, and move offer decisions through one governed ATS workflow.",
  ],
  [
    "Onboarding command",
    "Convert hires into employees with role setup, document collection, benefits steps, and task ownership.",
  ],
  [
    "Compliance vault",
    "Manage I-9 verifications, W-4 tax forms, EEO-1 reporting, secure documents, and audit-ready evidence.",
  ],
  [
    "Time and attendance",
    "Track shifts, clock events, work logs, overtime signals, and team capacity across locations.",
  ],
  [
    "Plugin operations",
    "Activate payroll, recruiting, communication, background check, and analytics connectors from an admin hub.",
  ],
  [
    "Workforce intelligence",
    "Give executives visibility into hiring velocity, compliance status, attendance trends, and operational risk.",
  ],
];
...
const commandSignals = [
  [
    "Hiring velocity",
    "Open roles, candidate stages, interviews, and offer readiness are visible in one pipeline.",
  ],
  [
    "Compliance posture",
    "Document completion, verification status, and reporting gaps are surfaced before they become risk.",
  ],
  [
    "Workforce coverage",
    "Shift demand, attendance, overtime, and availability signals help managers act earlier.",
  ],
  [
    "Operational ROI",
    "Plugin usage, support needs, and workflow adoption can be reviewed from the same operating view.",
  ],
];
...
const audiences = [
  [
    "For HR leaders",
    "Standardize employee data, document workflows, onboarding tasks, policies, and people operations governance.",
  ],
  [
    "For recruiters",
    "Manage candidate intake, pipeline stages, interviews, offers, and handoff to onboarding without spreadsheet drift.",
  ],
  [
    "For managers",
    "Review shift coverage, attendance, approvals, readiness, and team capacity before work gets blocked.",
  ],
  [
    "For executives",
    "See hiring performance, compliance readiness, attendance trends, and workforce operating health at a glance.",
  ],
];
    ...
    <main>
      ...
      <section className="page-hero hrms-hero hrms-image-hero">
        ...
        <div className="container hrms-image-hero-content">
          <div className="hrms-image-hero-copy">
            ...
            <h1>
              A workforce command center for hiring, compliance, attendance, and
              HR execution.
            </h1>
            <p className="lead">
              Tetraonix HRMS gives growing teams and staffing businesses a
              polished operating layer for recruiting, onboarding, US
              compliance, shift tracking, plugin integrations, and executive
          ...
          <div className="page-panel hrms-hero-panel">
            <div className="panel-top">
              <span>HR operating center</span>
              <strong>READY</strong>
            </div>
            <div className="metric-grid">
              <div className="metric">
                <strong>US</strong>
                <small>Compliance native</small>
              </div>
              <div className="metric">
                <strong>1 hub</strong>
                <small>ATS to onboarding</small>
              </div>
            </div>
            <div className="list">
      ...
      <section className="section hrms-command-section">
        <div className="container hrms-command-grid">
          <div className="dashboard-visual hrms-command-board">
            ...
            <h2>
              Make people operations feel controlled, current, and
              decision-ready.
            </h2>
            <p>
              The HRMS experience is structured around the moments where HR
              teams need clarity: who is moving through hiring, who is ready to
              start, who needs compliance attention, and where workforce
          ...
          <figure className="hrms-command-image">
            ...
            />
            <figcaption>
              Workforce command center for operational HR visibility
            </figcaption>
          </figure>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container section-head">
          ...
          <h2>
            Everything needed to run professional, compliant HR operations from
            intake to insight.
          </h2>
          <p>
            Each capability is built as part of a connected operating flow, so
            teams can move from hiring demand to compliant workforce execution
            without losing context between systems.
          </p>
        </div>
        <div className="container hrms-modules-workflow hrms-integrated-workflow">
          <figure className="hrms-modules-image">
            ...
            />
            <figcaption>
              Executive HRMS admin and full-cycle workflow pipeline
            </figcaption>
          </figure>
      ...
      <section className="section section-alt">
        ...
        <div className="container split hrms-confidence-layout">
          <div className="hrms-confidence-copy">
            ...
            <h2>
              Designed for staffing, consulting, and growing enterprise teams
              that need HR to move faster.
            </h2>
            <p>
              Use Tetraonix HRMS to standardize hiring operations, strengthen US
              labor compliance, manage shift tracking, and extend functionality
              through a practical plugin catalog.
            </p>
        ...
        <div className="container cta-card hrms-cta-card">
          <div>
            <span className="eyebrow">
              Ready for a stronger HR operating model?
            </span>
            <h2>
              Turn scattered HR workflows into one impressive enterprise
              experience.
            </h2>
            <p>
              Start with a focused HRMS demo covering recruiting, onboarding,
              compliance, attendance, analytics, and the plugin model your team
              needs next.
            </p>
            <a className="btn btn-primary" href="/contact">
              Plan HRMS Rollout
